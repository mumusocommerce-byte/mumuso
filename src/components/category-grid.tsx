...
const categories = [
    ...
    { name: "Stationery", handle: "stationary", image: "https://cdn.shopify.com/s/files/1/0511/6906/7163/files/STATIONERY_d2daf697-7683-4cfb-b4e1-d5652591754c.jpg?v=1773312468" },
